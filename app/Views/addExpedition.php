	...
	<body>
		...
		<table>
			<tr>
				...
				<td>:</td>
				<td>
					<input type="text" name="expedition_title" /> 
					
				</td>
			</tr>
			<tr>
				<td>Expedition Fee</td>
				<td>:</td>
				<td>
					<input type="text" name="expedition_fee" /> 
			...
			<tr>
				...
				<td>:</td>
				<td>
					<input type="text" name="expedition_days" /> 
					
				</td>
			</tr>
			<tr>
				<td>Expedition Nights</td>
				<td>:</td>
				<td>
					<input type="text" name="expedition_nights" /> 
			...
			<tr>
				<td>Overview</td>
				<td>:</td>
				<td><textarea name="expedition_overview" id="expedition_overview" class="summernote"></textarea></td>
			</tr>
