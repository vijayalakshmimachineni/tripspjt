	...
	<body>
		...
		<table>
			<tr>
				<td>trip</td>
				<td>:</td>
				<td><?php //echo $result->tripTitle; ?>
					<input type="text" name="trip_title" value="<?php echo $result->tripTitle; ?>"/> 
					<input type="hidden" name="trip_id" value="<?php echo $result->tripId; ?>"/> 
				</td>
			</tr><tr>
				<td>Overview</td>
				<td>:</td>
				<td><textarea name="trip_overview" id="tripOverview" class="summernote"><?php echo $result->tripOverview; ?></textarea></td>
			</tr>
			...
			<tr>
				...
				<td>:</td>
				<td><textarea name="terms" id="terms" class="summernote"><?php echo $result->termsConditions; ?></textarea></td>
			</tr>
			<tr>
				<td>How to reach</td>
				<td>:</td>
				<td><textarea name="map_image" id="mapImage" class="summernote"><?php echo $result->howToReach; ?></textarea></td>
			</tr>
			<tr>
